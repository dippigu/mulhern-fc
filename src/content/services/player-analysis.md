...
lead: Honest, development-focused football assessments for players aged 7-18+, and independent applicant evaluation for clubs and institutions. Grounded in elite standards shaped by international football, the WSL and the professional game.
order: 1
tags: []
features:
...
packageGroups:
  ...
  - title: In-Person Assessment
    description: Live observation of a match or training session in the North of England, followed by the full three-section assessment report.
    note: Travel costs may apply outside the immediate North East area.
    ukOnly: true
    items:
      - name: In-Person Standard
        detail: Live observation + full report
        priceGBP: 299
      - name: In-Person Premium
        detail: Live observation + full report + Zoom follow-up
        priceGBP: 369
        recommendedLabel: Best Value
      - name: Zoom Follow-Up
        detail: Add-on for existing in-person clients
        priceGBP: 75
audiences:
